   ...
   view.setFocusableInTouchMode(true);
	...
	public void addCard(Card card, Context context){
		...
		if(futureAdapter == null)
			futureAdapter = new CardArrayAdapter(_context, futureCards);
	...
	public void addPopUp(){
        ...
        LayoutInflater inflater = (LayoutInflater) CalendarFragment2.this
        	...
        	public void onClick(View v) {
        		...
        		if(popupInput.getText().toString().trim().length() > 0){
                  ...
                  //Create thumbnail
     		       ...
     		       if (d.before(today)) {
          		    	CalendarFragment3 cf3 = new CalendarFragment3();
          		    	cf3.addCard(card, _context);
